...
var author$project$Main$init = function (_n0) {
	return _Utils_Tuple2(
		A3(author$project$Main$Page, 'top.html', elm$core$Maybe$Nothing, elm$core$Maybe$Nothing),
	...
	function (msg, model) {
		switch (msg.$) {
			case 'ChangePage':
				...
				var codePath = msg.b;
				if (codePath.$ === 'Just') {
					var pagePath = codePath.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{codePath: codePath, demo: demo}),
						elm$http$Http$get(
							{
								expect: elm$http$Http$expectString(author$project$Main$GotCode),
								url: pagePath
							}));
				} else {
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{code: elm$core$Maybe$Nothing, codePath: codePath, demo: demo}),
						elm$core$Platform$Cmd$none);
				}
			case 'GotCode':
				var result = msg.a;
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												elm$html$Html$Events$onClick(
												A2(author$project$Main$ChangePage, 'form/index.html', elm$core$Maybe$Nothing))
											]),
										_List_fromArray(
											[
												elm$html$Html$text('form')
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										elm$html$Html$Attributes$src(model.demo)
									]),
								_List_Nil)
							])),
						function () {
